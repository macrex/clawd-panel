...
/* Dimensionado para o painel de 3,5" (grid em PSRAM). Portes com tela menor —
   ...
   NO CLAWD-PANEL estes tetos foram reduzidos: a tela em pé tem 320 px e a
   fonte da grade gasta 6 px por caractere, o que dá 52 colunas — não 220. Com
   os valores originais o grid passaria de 40 KB, e ele vive na PSRAM ao lado
   de um framebuffer de 300 KB. A lógica de parse não foi tocada.
   Ver lib/termparse/README.md. */
#ifndef TERM_MAX_LINES
#define TERM_MAX_LINES 56
#endif
#ifndef TERM_MAX_COLS
#define TERM_MAX_COLS  56
#endif
#ifndef TERM_MAX_RUNS
#define TERM_MAX_RUNS  1024   /* 56 linhas x ~18 runs medidos */
#endif
#ifndef TERM_TEXT_CAP
#define TERM_TEXT_CAP  6144   /* texto limpo + 1 NUL por run */
#endif
